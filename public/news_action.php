...
case 'ban_ip':
    ...
    try {
        ...
        echo json_encode(['success' => false, 'error' => 'Erreur bannissement']);
    }
    exit;
...
case 'unban_ip':
    ...
    try {
        ...
        echo json_encode(['success' => false, 'error' => 'Erreur débannissement']);
    }
    exit;
...
case 'get_commenters':
    ...
    try {
        ...
        echo json_encode(['success' => false, 'error' => 'Erreur chargement']);
    }
    exit;
