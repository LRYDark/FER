...
DROP TABLE IF EXISTS `partners_albums`;
...
DROP TABLE IF EXISTS `partners_years`;
...
INSERT INTO `photo_albums` (`id`, `year_id`, `album_title`, `album_link`, `album_img`, `album_desc`) VALUES
	(19, 11, 'Forbach en rose 2025', 'https://www.flickr.com/photos/199455542@N02/albums/72177720327352730', 'image_3261086_20250707_ob_96d37b_515923325-1277800833912878-59488173761.jpg', 'tati');
