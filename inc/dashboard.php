  ...
  <div class="offcanvas-body p-0">
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item d-flex align-items-center p-3">
        <i class="bi bi-arrow-repeat me-2 text-rose"></i>
        <button id="modeTS_m" class="btn btn-link text-start p-0 flex-grow-1">Remise T-shirts</button>
      </li>
      <li class="list-group-item d-flex align-items-center p-3">
        <i class="bi bi-gear me-2 text-rose"></i>
