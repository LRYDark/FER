...
$adminLinks = [
    ...
    'partners.php'  => ['Partenaires',      '<circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/>', ['admin']],
...
<div id="oc-app-container">
  ...
  <aside id="oc-sidebar">
    ...
    <div style="padding:12px 16px;font-size:15px;color:rgba(15,23,42,.3);text-align:center;font-weight:500;">Version 1.0.2</div>
  </aside>
