<?php
/**
 * Footer Moderne - Forbach en Rose
 * Fichier include pour le footer moderne réutilisable sur toutes les pages
 *
 * Requires: navbar-data.php doit être inclus pour avoir accès aux variables sociales
 * Variables requises: $link_facebook, $link_instagram, $link_twitter, $link_youtube
 */
?>
