...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-group input:focus { border-color: var(--primary, #f42182); box-shadow: 0 0 0 3px color-mix(in srgb, var(--primary, #f42182) 12%, transparent); }
    .oc-btn { width: 100%; padding: 10px; background: var(--primary, #f42182); color: var(--primary-text, #fff); border: none; border-radius: 6px; font-size: 14px; font-weight: 700; font-family: 'Inter', system-ui, sans-serif; cursor: pointer; margin-top: 8px; transition: background 0.15s; text-decoration: none; display: block; text-align: center; }
    .oc-btn:hover { background: var(--primary, #f42182); color: var(--primary-text, #fff); }
