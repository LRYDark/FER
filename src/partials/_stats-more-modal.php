...
<style nonce="<?= $GLOBALS['csp_nonce'] ?? '' ?>">
  ...
  .reg-stats-section-title{font-size:.72rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:var(--accent);margin:0 0 .45rem}
  .reg-stats-list{border:1px solid var(--border);border-radius:.65rem;overflow:hidden}
  ...
  .reg-stats-row:nth-child(even){background:var(--surface-2)}
  .reg-stats-row-label{font-size:.86rem;color: var(--ink-dim);font-weight:500}
  .reg-stats-row-value{font-size:.9rem;font-weight:700;color: var(--ink);text-align:right}
  .reg-stats-rank{color:var(--accent);font-weight:700}
</style>
