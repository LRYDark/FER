...
<div id="ferChatbot"
  ...
  <div class="fcb-window" role="dialog" aria-label="Rosie, assistante de Forbach en Rose">
    <div class="fcb-header">
      ...
      <div class="fcb-head-txt">
        <strong>Rosie</strong>
        <small><span class="fcb-dot"></span> Assistante Forbach en Rose — en ligne</small>
      </div>
  ...
  <button type="button" class="fcb-bubble" aria-label="Ouvrir Rosie, l'assistante" aria-expanded="false">
